...
$sentencia = $base_de_datos->query("
    SELECT ur.id_usuario, u.nombre, ur.id_rol, r.nombre_rol, 
                    ...
                    <table class="table table-bordered" aria-labelledby="modalEliminadosLabel">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td data-label="Usuario Eliminó"><?php echo $ur->usr_delete ?></td>
                          <td data-label="Acciones">
                            <a class="btn btn-warning btn-sm" href="<?php echo "restore_usuarios_roles.php?id_usuario=" . $ur->id_usuario . "&id_rol=" . $ur->id_rol ?>" aria-label="Restaurar asignación del usuario <?php echo $ur->nombre; ?> al rol <?php echo $ur->nombre_rol; ?>">
          ...
          <table class="table table-bordered table-striped" aria-describedby="tablaUsuariosRolesCaption">
            <caption id="tablaUsuariosRolesCaption" style="position:absolute; width:1px; height:1px; padding:0; margin:-1px; overflow:hidden; clip:rect(0,0,0,0); border:0;">Listado de asignaciones de roles a usuarios</caption>
                ...
                <tbody>
                  ...
                  <td data-label="Usuario Insertó"><?php echo $ur->usr_insert ?></td>
                  <td class="actions-cell" data-label="Acciones">
                    <a class="btn btn-warning btn-sm" href="editar_usuarios_roles.php?id_usuario=<?php echo $ur->id_usuario; ?>&id_rol=<?php echo $ur->id_rol; ?>" aria-label="Editar asignación del usuario <?php echo $ur->nombre; ?> al rol <?php echo $ur->nombre_rol; ?>">
                      ...
                      <button type="submit" class="btn btn-danger btn-sm" aria-label="Eliminar asignación del usuario <?php echo $ur->nombre; ?> al rol <?php echo $ur->nombre_rol; ?>">
