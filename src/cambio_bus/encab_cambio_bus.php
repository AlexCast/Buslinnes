...
<head>
    ...
    <title>BusLinnes | cambio de bus</title>
    <!--Favicon-->
    ...
    <header class="header-container">
        <div class="header-content">
            <div class="brand-section">
                ...
                <div>
                    <div class="brand-text">BusLinnes | Buses</div>
                </div>
            </div>
            
            <nav class="nav-menu">
                <div class="nav-item">
                    <a href="listar_cambio_bus.php" class="nav-link">
                        <i class="fas fa-list"></i>
                        <span>Listar</span>
                    </a>
                </div>
                <div class="nav-item">
                    <a href="forma_cambio_bus.php" class="nav-link">
