...
<head>
    ...
    <title>BusLinnes | Mantenimientos</title>
    <!--Favicon-->
    ...
    <header class="header-container">
        <div class="header-content">
            <div class="brand-section">
                ...
                <div>
                    <div class="brand-text">BusLinnes | Mantenimientos</div>
                </div>
            </div>
            
            <nav class="nav-menu">
                <div class="nav-item">
                    <a href="listar_mantenimiento.php" class="nav-link">
                        <i class="fas fa-list"></i>
                        <span>Listar</span>
                    </a>
                </div>
                <div class="nav-item">
                    <a href="forma_mantenimiento.php" class="nav-link">
