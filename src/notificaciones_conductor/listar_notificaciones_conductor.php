...
// Listado de notificaciones visibles para el conductor autenticado.
define('VALIDAR_JWT_MANUAL', true);
require_once __DIR__ . '/../validar_jwt.php';
$jwt = validarTokenJWT(['conductor', 'admin']);
...
<?php include_once __DIR__ . '/encab_notificaciones_conductor.php'; ?>
