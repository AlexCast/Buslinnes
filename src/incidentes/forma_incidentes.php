                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="id_incidente" name="id_incidente" class="form-control" placeholder="Ingrese el ID del incidente" required pattern="^[0-9]+$" minlength="1" maxlength="10" onkeydown="return event.key !== 'e' && event.key !== 'E'">
                                </div>
                                <div class="form-group mb-3">
