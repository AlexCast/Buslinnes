...
// Contar incidentes eliminados
$incidentesEliminados = array_filter($incidentes, function($incidente) {
    return !empty($incidente->fec_delete);
});
?>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="d-flex gap-3 mb-4">
            ...
            <button type="button" class="badge bg-danger p-2" id="btnEliminados" style="cursor:pointer;" aria-haspopup="dialog" aria-controls="modalEliminados">Eliminados: <?php echo count($incidentesEliminados); ?></button>
        </div>

        <!-- Modal flotante para incidentes eliminados -->
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="modalEliminadosLabel">Incidentes Eliminados</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
              </div>
              <div class="modal-body">
                <?php if (count($incidentesEliminados) === 0): ?>
                  <div class="alert alert-info">No hay incidentes eliminados.</div>
                <?php else: ?>
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php foreach ($incidentesEliminados as $incidente): ?>
                          <tr>
