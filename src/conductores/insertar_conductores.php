...
$email_conductor = trim((string) ($_POST["email_conductor"] ?? $_POST["tel_conductor"]));
...
try {
    $sentencia = $base_de_datos->prepare("SELECT fun_insert_conductores(?::int, ?::varchar, ?::varchar, ?::char(1), ?::varchar, ?::varchar, ?::char(2), ?::date, ?::char(1), ?::date, ?::varchar) AS resultado;");
    $sentencia->execute([
        $id_usuario,
        $nom_conductor,
        $ape_conductor,
    ...
    if ($resultadoOk || (is_string($mensaje) && stripos($mensaje, 'insertado correctamente') !== false)) {
