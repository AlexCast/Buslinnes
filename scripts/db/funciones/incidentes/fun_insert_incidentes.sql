CREATE OR REPLACE FUNCTION fun_insert_incidentes(
    ...
    wtipo_incidente tab_incidentes.tipo_incidente%TYPE DEFAULT 'O'
) RETURNS BOOLEAN AS
$$
BEGIN
    -- Validaciones
    ...
    INSERT INTO tab_incidentes(id_incidente, titulo_incidente, desc_incidente, id_bus, id_usuario, tipo_incidente)
    VALUES (wid_incidente, wtitulo_incidente, wdesc_incidente, wid_bus, wid_usuario, wtipo_incidente);
